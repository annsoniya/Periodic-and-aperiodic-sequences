function plot_mean_rates_without(per,aper)
% Current matrix
...
LineStyle = '--';
p1 = plot(columnMeans, 'LineWidth', 2, 'Color', 'g', 'LineStyle', '--', 'DisplayName', 'Periodic'); % Use 'DisplayName' for legend

errorbar(1:length(columnMeans), columnMeans, columnSEMs, 'LineStyle', 'none', 'Color', 'g');
p2 = plot(columnMeans2, 'LineWidth', 2, 'Color', 'r', 'LineStyle', '--', 'DisplayName', 'Aperiodic'); % Use 'DisplayName' for legend
