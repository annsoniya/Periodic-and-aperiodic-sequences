...
sorted_data_per = data_per_4(sorted_indices_per, :); % dataof all cells inthe sorted order
...
%plot
sorted_data_aper = data_aper_4(sorted_indices_aper, :);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_per_withmeanzero=data_per_4;
...
% sort aperiodic data based on mean values from highest to lowest
sorted_data_aper = data_aper_4(sorted_indices_per, :);
for y = 1:size(sorted_data_aper, 1)
    mean_sorted_data_aper(y, :) = mean(cat(1, sorted_data_aper{y, :}));
end
